...
ggplot(annual, aes(x=score, y = total, fill = score)) +
      geom_boxplot() +
      stat_summary(fun = "mean", geom = "point", shape = 8, size = 2, color = "white") +
      labs(x = "Year", y = "Annual Precipitation (mm)") +
      theme(panel.background = element_rect(fill = "white", colour = "black")) +
      theme(aspect.ratio = 1) +
      ggtitle("Annual Precipitation Albasini Dam, South Africa") +
      theme(plot.title = element_text(face = "bold", size = (12), colour = "steelblue4")) +
